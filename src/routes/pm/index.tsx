...
// ── Create dialog ─────────────────────────────────────────────────────────────
// CreateDialog/FuncaoLinha/novaLinhaFuncao/SCOPE_DOCUMENT_TYPES/uploadScopeDocument/
// useNominationFormData/currentAuthUserId foram extraídos pra src/components/nominations/
// CreateNominationDialog.tsx, pra serem reaproveitados também no ambiente da Logística (ver
// src/routes/admin/nominations.tsx) sem criar uma dependência circular entre as duas rotas
// (esta rota já importa NominationsPage de admin/nominations.tsx).
