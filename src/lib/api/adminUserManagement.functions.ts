...
export const adminCreateUser = createServerFn({ method: "POST" })
  ...
  .handler(async ({ data, context }) => {
    ...
    // Papéis novos (pm/aprovacao_tecnica/qualidade/rh/sms) ainda não estão nos tipos gerados
    // do Supabase; cast local pra não bloquear o build (mesmo padrão já usado em outros
